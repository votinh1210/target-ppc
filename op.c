...
void OPPROTO op_vec_pack_pixel(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_pixel(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_shss(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_shss(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_shus(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_shus(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_swss(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_swss(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_swus(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_swus(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_uhum(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_uhum(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_uhus(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
...
void OPPROTO op_vec_pack_uwum(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_uwum(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_pack_uwus(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_pack_uwus(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_unpack_hpx(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_unpack_hpx(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_unpack_lpx(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_unpack_lpx(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_unpack_hsb(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_unpack_hsb(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_unpack_lsb(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_unpack_lsb(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_unpack_hsh(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_unpack_hsh(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
void OPPROTO op_vec_unpack_lsh(void)                  //mari
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_unpack_lsh(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}

void OPPROTO op_vec_add_cuw(void)
{
     T0 = (int32_t)PARAM1;     //vrt
     T1 = (int32_t)PARAM2;     //vra
     T2 = (int32_t)PARAM3;     //vrb
     do_vector_add_cuw(T0,T1,T2);
     do_printf_vector(T0);
     RETURN();
}
