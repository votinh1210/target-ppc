...
void do_vector_pack_pixel(int j, int a, int b);
void do_vector_pack_shss(int j,int a,int b);
void do_vector_pack_shus(int j,int a,int b);
void do_vector_pack_swss(int j,int a,int b);
void do_vector_pack_swus(int j,int a,int b);
void do_vector_pack_uhum(int j,int a,int b);
void do_vector_pack_uhus(int j,int a,int b);  
void do_vector_pack_uwum(int j,int a,int b);
void do_vector_pack_uwus(int j,int a,int b);
void do_vector_unpack_hpx(int j,int a,int b);
void do_vector_unpack_lpx(int j,int a,int b);
void do_vector_unpack_hsb(int j,int a,int b);
void do_vector_unpack_lsb(int j,int a,int b);
void do_vector_unpack_hsh(int j,int a,int b);
void do_vector_unpack_lsh(int j,int a,int b);
...
//get the bits in the intervals of chain
unsigned int chooseInterval(unsigned int, unsigned int, unsigned int);
//function EXTS with length of bits
signed int EXTS(unsigned int, unsigned int);
int ClampS(signed int a, int lowerLimit, int upperLimit);
unsigned int ClampU(unsigned int a, unsigned int lowerLimit, unsigned int upperLimit);
