...
GEN_HANDLER(vpkpx,0x04,0x07,0x0c,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_pixel(rs,ra,rb);     
}

GEN_HANDLER(vpkshss,0x04,0x07,0x06,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_shss(rs,ra,rb);     
}

GEN_HANDLER(vpkshus,0x04,0x07,0x04,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_shus(rs,ra,rb);     
}

GEN_HANDLER(vpkswss,0x04,0x07,0x07,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_swss(rs,ra,rb);     
}

GEN_HANDLER(vpkswus,0x04,0x07,0x05,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_swus(rs,ra,rb);     
}

GEN_HANDLER(vpkuhum,0x04,0x07,0x00,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_uhum(rs,ra,rb);     
}

GEN_HANDLER(vpkuhus,0x04,0x07,0x02,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_uhus(rs,ra,rb);     
}

GEN_HANDLER(vpkuwum,0x04,0x07,0x01,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_uwum(rs,ra,rb);     
}

GEN_HANDLER(vpkuwus,0x04,0x07,0x03,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_pack_uwus(rs,ra,rb);     
}

GEN_HANDLER(vupkhpx,0x04,0x07,0x0d,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_unpack_hpx(rs,ra,rb);     
}

GEN_HANDLER(vupklpx,0x04,0x07,0x0f,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_unpack_lpx(rs,ra,rb);     
}

GEN_HANDLER(vupkhsb,0x04,0x07,0x08,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_unpack_hsb(rs,ra,rb);     
}

GEN_HANDLER(vupklsb,0x04,0x07,0x0a,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_unpack_lsb(rs,ra,rb);     
}

GEN_HANDLER(vupkhsh,0x04,0x07,0x09,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_unpack_hsh(rs,ra,rb);     
}

GEN_HANDLER(vupklsh,0x04,0x07,0x0b,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_unpack_lsh(rs,ra,rb);     
}

GEN_HANDLER(vaddcuw,0x04,0x0,0x06,0x00000000,PPC_INTEGER)               //mari
{
       int rs,ra,rb;
       rs = rS(ctx->opcode);
       ra = rA(ctx->opcode);
       rb = rB(ctx->opcode);
       gen_op_vec_add_cuw(rs,ra,rb);     
}
